...
import 'package:eIDSR/pages/mcbs/pages/tools/mcbs_tools.dart';
...
class McbsPage extends StatefulWidget {
  final int? indexToInherit;

  const McbsPage({Key? key, this.indexToInherit: null}) : super(key: key);

  @override
  _McbsPageState createState() => _McbsPageState();
}
...
class _McbsPageState extends State<McbsPage> {
  int currentIndex = 0;
  ...
  List<Widget> pages = [McbsTools(), McbsSummary(), McbsNotifications(), SyncHome()];
  List<dynamic> pageTileConfigs = [
    ...
    {
      "title": Text("mCBS Summary"),
    },
    {
      "title": Text("mCBS Notifications"),
    },
    {
      "title": Text("mCBS Sync"),
    }
  ];
