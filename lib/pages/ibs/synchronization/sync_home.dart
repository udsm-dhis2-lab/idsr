...
class SyncHome extends StatefulWidget {
  const SyncHome({Key? key}) : super(key: key);

  @override
  _SyncHomeState createState() => _SyncHomeState();
}
...
class _SyncHomeState extends State<SyncHome> {
