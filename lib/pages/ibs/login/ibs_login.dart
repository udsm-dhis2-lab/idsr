...
import '../ibs_home_page.dart';

class IbsLoginPage extends StatefulWidget {
  const IbsLoginPage({Key? key}) : super(key: key);

  @override
  _IbsLoginPageState createState() => _IbsLoginPageState();
}

class _IbsLoginPageState extends State<IbsLoginPage> {
  String username = '';
  String password = '';
  ...
  _login(String username, String password) async {
    ...
    if (isAuthenticated) {
      ...
      await prefs.setString("loggedInItervention", "ibs");
      ...
      try {
        ...
        final dynamic backToLogin = await Navigator.push(
            context, MaterialPageRoute(builder: (context) => IBSPage()));
